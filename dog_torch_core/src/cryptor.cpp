...
#define NSROOT dog_torch::crypto::symmetric


//padding&unpadding
NSROOT::padding::Config::Config(std::string name, uint64_t code)
{
	this->name = name;
	this->code = code;
}
const NSROOT::padding::Config NSROOT::padding::NONE_CONFIG = Config("NONE", 0);
void NSROOT::padding::NONE_padding(dog_torch::serialize::Data& data, uint64_t block_size)
{
}
void NSROOT::padding::NONE_unpadding(dog_torch::serialize::Data& data, uint64_t block_size)
{
}

const NSROOT::padding::Config NSROOT::padding::PKCS7_CONFIG = Config("PKCS7", 1);
void NSROOT::padding::PKCS7_padding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (block_size > 0x100)
	{
...
void NSROOT::padding::PKCS7_unpadding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (block_size > 0x100)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Block size is too big,PKCS7 only support less than 256\n错误：块大小过大，PKCS7仅支持小于256B的块"));
...
const NSROOT::padding::Config NSROOT::padding::ZERO_CONFIG = Config("ZERO", 2);
void NSROOT::padding::ZERO_padding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (data.size() > block_size)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Data size is bigger than block size\n错误：数据长度大于块大小"));
...
void NSROOT::padding::ZERO_unpadding(dog_torch::serialize::Data& data, uint64_t block_size)
{
...
const NSROOT::padding::Config NSROOT::padding::ANSIX923_CONFIG = Config("ANSIX923", 3);
void NSROOT::padding::ANSIX923_padding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (block_size > 0x100)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Block size is too big,PKCS7 only support less than 256\n错误：块大小过大，PKCS7仅支持小于256B的块"));
...
void NSROOT::padding::ANSIX923_unpadding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (block_size > 0x100)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Block size is too big,PKCS7 only support less than 256\n错误：块大小过大，PKCS7仅支持小于256B的块"));
...
const NSROOT::padding::Config NSROOT::padding::ISO7816_4_CONFIG = Config("ISO7816_4", 4);
void NSROOT::padding::ISO7816_4_padding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (data.size() > block_size)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Data size is bigger than block size\n错误：数据长度大于块大小"));
...
void NSROOT::padding::ISO7816_4_unpadding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	while (*data.rbegin() == 0x00)
	{
		data.pop_back();
...
const NSROOT::padding::Config NSROOT::padding::ISO10126_CONFIG = Config("ISO10126", 5);
void NSROOT::padding::ISO10126_padding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (block_size > 0x100)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Block size is too big,PKCS7 only support less than 256\n错误：块大小过大，PKCS7仅支持小于256B的块"));
...
void NSROOT::padding::ISO10126_unpadding(dog_torch::serialize::Data& data, uint64_t block_size)
{
	if (block_size > 0x100)
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Block size is too big,PKCS7 only support less than 256\n错误：块大小过大，PKCS7仅支持小于256B的块"));
...
const std::vector<NSROOT::padding::Config> NSROOT::padding::list = {
	PKCS7_CONFIG,
	ZERO_CONFIG,
	ANSIX923_CONFIG,
	ISO7816_4_CONFIG,
...
//multi_mode
NSROOT::mode::Config::Config(std::string name, uint64_t code, bool force_iv, bool force_padding, bool force_shift)
{
	this->name = name;
	this->code = code;
	this->force_iv = force_iv;
	this->force_padding = force_padding;
	this->force_shift = force_shift;
}

const NSROOT::mode::Config NSROOT::mode::ECB::CONFIG = Config("ECB", 0, false, true, false);
dog_torch::serialize::Data NSROOT::mode::ECB::encrypt(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
...
dog_torch::serialize::Data NSROOT::mode::ECB::decrypt(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
...
void NSROOT::mode::ECB::encrypt_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
...
void NSROOT::mode::ECB::decrypt_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
...
void NSROOT::mode::ECB::encrypt_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
...
void NSROOT::mode::ECB::decrypt_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::CBC::encrypt(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
...
dog_torch::serialize::Data NSROOT::mode::CBC::decrypt(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
...
void NSROOT::mode::CBC::encrypt_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::CBC::decrypt_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::CBC::encrypt_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::CBC::decrypt_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::PCBC::encrypt(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((plain.size() / block_size) + 1) * block_size);
...
dog_torch::serialize::Data NSROOT::mode::PCBC::decrypt(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((crypt.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0, tempBlock1 = iv, tempBlock2;
...
void NSROOT::mode::PCBC::encrypt_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::PCBC::decrypt_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::PCBC::encrypt_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
...
void NSROOT::mode::PCBC::decrypt_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::OFB::encrypt(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((plain.size() / block_size) + 1) * block_size);
...
dog_torch::serialize::Data NSROOT::mode::OFB::decrypt(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(crypt.size());
	dog_torch::serialize::Data tempBlock0 = iv;
...
void NSROOT::mode::OFB::encrypt_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::OFB::decrypt_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::OFB::encrypt_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::OFB::decrypt_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::CTR::encrypt(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((plain.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
dog_torch::serialize::Data NSROOT::mode::CTR::decrypt(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((crypt.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
void NSROOT::mode::CTR::encrypt_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::CTR::decrypt_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::CTR::encrypt_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::CTR::decrypt_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::CFBB::encrypt(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	//反馈字节数
...
dog_torch::serialize::Data NSROOT::mode::CFBB::decrypt(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t nbyte = cryptor.get_reback_size();
...
void NSROOT::mode::CFBB::encrypt_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::CFBB::decrypt_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBB::encrypt_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBB::decrypt_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::CFBB::encrypt_CFB8(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((plain.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
dog_torch::serialize::Data NSROOT::mode::CFBB::decrypt_CFB8(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((crypt.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
void NSROOT::mode::CFBB::encrypt_CFB8_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::CFBB::decrypt_CFB8_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBB::encrypt_CFB8_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBB::decrypt_CFB8_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::CFBb::encrypt_CFB1(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((plain.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
dog_torch::serialize::Data NSROOT::mode::CFBb::decrypt_CFB1(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((crypt.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
void NSROOT::mode::CFBb::encrypt_CFB1_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::CFBb::decrypt_CFB1_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBb::encrypt_CFB1_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBb::decrypt_CFB1_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
dog_torch::serialize::Data NSROOT::mode::CFBB::encrypt_CFB128(dog_torch::serialize::Data plain, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((plain.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
dog_torch::serialize::Data NSROOT::mode::CFBB::decrypt_CFB128(dog_torch::serialize::Data crypt, dog_torch::serialize::Data iv, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	dog_torch::serialize::Data res; res.reserve(((crypt.size() / block_size) + 1) * block_size);
	dog_torch::serialize::Data tempBlock0 = iv;
...
void NSROOT::mode::CFBB::encrypt_CFB128_stream(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
	uint64_t file_size = plain.tellg();
...
void NSROOT::mode::CFBB::decrypt_CFB128_stream(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
	crypt.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBB::encrypt_CFB128_streamp(std::istream& plain, dog_torch::serialize::Data iv, std::ostream& crypt, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	plain.seekg(0, std::ios::end);
...
void NSROOT::mode::CFBB::decrypt_CFB128_streamp(std::istream& crypt, dog_torch::serialize::Data iv, std::ostream& plain, NSROOT::Cryptor& cryptor,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = cryptor.get_block_size();
	uint64_t now_pos = crypt.tellg();
...
const std::vector<NSROOT::AlgorithmConfig> NSROOT::Algorithm_list = {
	NSROOT::AES::CONFIG,
	NSROOT::SM4::CONFIG,
	NSROOT::camellia::CONFIG,
	NSROOT::Twofish::CONFIG
};

NSROOT::CryptionConfig::CryptionConfig(
...
dog_torch::serialize::Data NSROOT::CryptionConfig::to_data() const
{
	...
	if (using_padding)
	{
		using namespace NSROOT::padding;
		bool is_fill = false;
		for (auto& config : NSROOT::padding::list)
		{
...
NSROOT::CryptionConfig NSROOT::CryptionConfig::get_cryption_config(std::istream& config_stream, bool return_start)
{
	try
	{
		NSROOT::CryptionConfig config;
		...
		{
			config.padding_function = NSROOT::padding::NONE_CONFIG.name;
		}
		value = dog_torch::serialize::tlv::read(config_stream);
...
NSROOT::CryptionConfig NSROOT::CryptionConfig::get_cryption_config(dog_torch::serialize::Data& config_data, bool is_cut)
{
	try
	{
		NSROOT::CryptionConfig config;
...
bool NSROOT::Cryptor::is_config_available(const CryptionConfig& config)
{
	std::unique_ptr<NSROOT::AlgorithmConfig> algorithm_config;
	for (auto& algorithm : NSROOT::Algorithm_list)
	{
		if (algorithm.name == config.cryption_algorithm)
		{
			algorithm_config = std::make_unique<NSROOT::AlgorithmConfig>(algorithm);
		}
	}
	if (!algorithm_config)
	{
	...
	{
		std::unique_ptr<NSROOT::padding::Config> padding_config;
		for (auto& padding : NSROOT::padding::list)
		{
			if (padding.name == config.padding_function)
			{
				padding_config = std::make_unique<NSROOT::padding::Config>(padding);
			}
		}
		if (!padding_config)
		{
...
std::unordered_map<std::string, std::any> NSROOT::Cryptor::turn_map(std::vector<std::pair<std::string, std::any>> vec)
{
...
std::vector<std::pair<std::string, std::any>> NSROOT::Cryptor::turn_vec(std::unordered_map<std::string, std::any> map)
{
	...
	std::vector<std::pair<std::string, std::any>> extra_config)
{
	...
	/*
	else if (name == NSROOT::type::name)
	{
		using namespace NSROOT::camellia;
...
if (name == NSROOT::type::CONFIG.name)\
{\
	using namespace NSROOT::type;\
...
void NSROOT::Cryptor::swap_config(Cryptor& other)
{
	std::swap(this->is_valid_, other.is_valid_);
	std::swap(this->config_, other.config_);
	std::swap(this->extend_key_, other.extend_key_);
...
dog_torch::serialize::Data NSROOT::Cryptor::get_original_key() const
{
	return this->original_key_;
}
dog_torch::serialize::Data NSROOT::Cryptor::get_available_key() const
{
	return this->key_;
}
NSROOT::Cryptor::padding_func NSROOT::Cryptor::get_padding() const
{
	return this->padding_;
}
NSROOT::Cryptor::padding_func  NSROOT::Cryptor::get_unpadding() const
{
	return this->unpadding_;
}
NSROOT::Cryptor::block_self_cryption_func NSROOT::Cryptor::get_block_self_encryption() const
{
	return this->block_encryption_self_;
}
NSROOT::Cryptor::block_self_cryption_func NSROOT::Cryptor::get_block_self_decryption() const
{
	return this->block_decryption_self_;
}
NSROOT::Cryptor::block_cryption_func NSROOT::Cryptor::get_block_encryption() const
{
	return this->block_encryption_;
}
NSROOT::Cryptor::block_cryption_func NSROOT::Cryptor::get_block_decryption() const
{
	return this->block_decryption_;
}
NSROOT::CryptionConfig NSROOT::Cryptor::get_config()
{
	return this->config_;
}
uint64_t NSROOT::Cryptor::get_reback_size() const
{
...
bool NSROOT::Cryptor::is_available() const
{
	if (!this->is_valid_)
	{
...
dog_torch::serialize::Data NSROOT::Cryptor::encrypt(dog_torch::serialize::Data plain, bool with_config, bool with_iv, dog_torch::serialize::Data iv, bool with_check)
{
	...
	if (with_check)
	{
		dog_torch::serialize::Data check = NSROOT::utils::get_sequence(this->config_.block_size);
...
void NSROOT::Cryptor::encrypt(std::istream& plain, std::ostream& crypt, bool with_config, bool with_iv, dog_torch::serialize::Data iv, bool with_check)
{
	if (!this->is_available())
	{
		throw CryptionException(DOG_EXCEPTION_MSG_OPINION("Error:Cryptor config is invalid\n错误：Cryptor加密器配置无效"));
...
void NSROOT::Cryptor::encryptp(std::istream& plain, std::ostream& crypt, bool with_config, bool with_iv, dog_torch::serialize::Data iv, bool with_check,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	if (!this->is_available())
	{
...
dog_torch::serialize::Data NSROOT::Cryptor::decrypt(dog_torch::serialize::Data crypt, bool with_config, bool with_iv, dog_torch::serialize::Data iv, bool with_check)
{
	std::unique_ptr<NSROOT::Cryptor> ori_cryptor;
	if (with_config)
	{
		ori_cryptor = std::make_unique<NSROOT::Cryptor>(*this);
		NSROOT::Cryptor temp_cryptor(NSROOT::CryptionConfig::get_cryption_config(crypt, true));
	...
	if (with_check)
	{
		...
		dog_torch::serialize::Data plain_check = NSROOT::utils::get_sequence(this->config_.block_size);
...
void NSROOT::Cryptor::decrypt(std::istream& crypt, std::ostream& plain, bool with_config, bool with_iv, dog_torch::serialize::Data iv, bool with_check)
{
	std::unique_ptr<NSROOT::CryptionConfig> ori_config;
	if (with_config)
	{
		NSROOT::CryptionConfig config = NSROOT::CryptionConfig::get_cryption_config(crypt, false);
		ori_config = std::make_unique<NSROOT::CryptionConfig>(this->config_);
		this->config_ = config;
	}
	if (!this->is_available())
	{
...
void NSROOT::Cryptor::decryptp(std::istream& crypt, std::ostream& plain, bool with_config, bool with_iv, dog_torch::serialize::Data iv, bool with_check,
	std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	std::unique_ptr<NSROOT::CryptionConfig> ori_config;
	if (with_config)
