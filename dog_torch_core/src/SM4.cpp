#include "crypto/symmetric/SM4.h"//SM4

//unit单位:uint8_t字节
const dog_torch::crypto::symmetric::AlgorithmConfig dog_torch::crypto::symmetric::SM4::CONFIG = AlgorithmConfig("SM4", "[16,16]0", "[16,16]0");

const uint8_t dog_torch::crypto::symmetric::SM4::SBox[16][16] = {
...
const uint32_t dog_torch::crypto::symmetric::SM4::FK[4] = { 0xa3b1bac6, 0x56aa3350, 0x677d9197, 0xb27022dc };
const uint32_t dog_torch::crypto::symmetric::SM4::CK[32] = { 0x00070e15,0x1c232a31,0x383f464d,0x545b6269,0x70777e85,0x8c939aa1,0xa8afb6bd,0xc4cbd2d9,
					  0xe0e7eef5,0xfc030a11,0x181f262d,0x343b4249,0x50575e65,0x6c737a81,0x888f969d,0xa4abb2b9,
					  0xc0c7ced5,0xdce3eaf1,0xf8ff060d,0x141b2229,0x30373e45,0x4c535a61,0x686f767d,0x848b9299,
					  0xa0a7aeb5,0xbcc3cad1,0xd8dfe6ed,0xf4fb0209,0x10171e25,0x2c333a41,0x484f565d,0x646b7279 };
//400

uint32_t dog_torch::crypto::symmetric::SM4::TMixChange1(uint32_t n)
{
	uint32_t res = 0;
	for (int i = 0; i < 4; i++)
	{
...
uint32_t dog_torch::crypto::symmetric::SM4::TMixChange2(uint32_t n)
{
	uint32_t res = 0;
...
dog_torch::serialize::Data dog_torch::crypto::symmetric::SM4::extend_key(dog_torch::serialize::Data key, uint64_t key_size)
{
	dog_torch::serialize::Data res; res.reserve(128);
	uint32_t K[36];
...
dog_torch::serialize::Data dog_torch::crypto::symmetric::SM4::encoding(dog_torch::serialize::Data& plain, uint64_t block_size, const dog_torch::serialize::Data& key, uint64_t key_size)
{
	...
	dog_torch::serialize::Data res; res.reserve(16);
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
		{
...
dog_torch::serialize::Data dog_torch::crypto::symmetric::SM4::decoding(dog_torch::serialize::Data& crypt, uint64_t block_size, const dog_torch::serialize::Data& key, uint64_t key_size)
{
	uint32_t temp[4] = { 0,0,0,0 };
	for (int i = 0; i < 16; i += 4)
	{
...
void dog_torch::crypto::symmetric::SM4::encoding_self(dog_torch::serialize::Data& plain, uint64_t block_size, const dog_torch::serialize::Data& key, uint64_t key_size)
{
	uint32_t temp[4] = { 0,0,0,0 };
	for (int i = 0; i < 16; i += 4)
	{
...
void dog_torch::crypto::symmetric::SM4::decoding_self(dog_torch::serialize::Data& crypt, uint64_t block_size, const dog_torch::serialize::Data& key, uint64_t key_size)
{
	uint32_t temp[4] = { 0,0,0,0 };
	for (int i = 0; i < 16; i += 4)
	{
