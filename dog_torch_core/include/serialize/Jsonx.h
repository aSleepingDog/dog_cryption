...
namespace dog_torch::serialize::jsonx
{
    ...
    namespace any
    {
		...
		DOG_CRYPTION_API std::string to_json_str(int64_t number);
		DOG_CRYPTION_API std::string to_json_str(uint64_t number);
		...
		DOG_CRYPTION_API int64_t         to_int64       (std::string::const_iterator& now, std::string::const_iterator end);
		DOG_CRYPTION_API uint64_t        to_uint64      (std::string::const_iterator& now, std::string::const_iterator end);
		DOG_CRYPTION_API double          to_float64     (std::string::const_iterator& now, std::string::const_iterator end);
	...
	private:
		std::variant<
			std::nullptr_t, bool, int64_t, uint64_t, double, std::string, std::vector<Value>, std::unordered_map<std::string, Value>
		> value_;
	public:
		Value();
