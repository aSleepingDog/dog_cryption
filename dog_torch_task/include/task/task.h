...
namespace dog_work
{
    ...
    private:
        ...
        std::string output;
        dog_torch::serialize::Data result_;
        std::string type_;
    ...
    public:
        ...
        *     upper bool 输出是否大写
        */
        Task(uint64_t id, std::string input, dog_torch::crypto::hash::HashCrypher hash_crypher, std::unordered_map<std::string, std::any> output_params);
        Task(uint64_t id, int type, std::string input, std::string output, dog_torch::crypto::symmetric::Cryptor& cryptor,
    ...
    public:
        ...
        uint64_t add_hash(std::string path, dog_torch::crypto::hash::HashCrypher& hash_crypher, std::unordered_map<std::string,std::any> output_params);
        uint64_t add_hash(dog_param::IOConfig input_config, dog_torch::crypto::hash::HashCrypher& hash_crypher, dog_param::IOConfig output_config);
        uint64_t add_encrypt(std::string input_path, std::string output_path, dog_torch::crypto::symmetric::Cryptor& cryptor, 
            dog_torch::serialize::Data iv, bool with_config, bool with_iv, bool with_check);
        uint64_t add_decrypt(std::string input_path, std::string output_path, dog_torch::crypto::symmetric::Cryptor& cryptor,
            dog_torch::serialize::Data iv, bool with_config, bool with_iv, bool with_check);
