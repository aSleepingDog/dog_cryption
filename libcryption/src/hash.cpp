...
void dog_hash::HashCrypher::streamHashp(HashCrypher& crypher, std::istream& data, dog_data::Data* result,std::mutex* mutex_, std::condition_variable* cond_, std::atomic<double>* progress, std::atomic<bool>* running_, std::atomic<bool>* paused_, std::atomic<bool>* stop_)
{
	uint8_t block_size = crypher.block_size_;
	data.seekg(0, std::ios::end);
	uint64_t file_size = data.tellg();
...
//SHA2
const std::string dog_hash::SHA2::name = "SHA2";
const std::string dog_hash::SHA2::effective_region = "32,28|64,48";
const dog_hash::HashConfig dog_hash::SHA2::config = HashConfig(name, effective_region);
...
const uint32_t dog_hash::SHA2::k_256[64] = {
...
const dog_data::Data dog_hash::SHA2::b256::IV = "6A09E667BB67AE853C6EF372A54FF53A510E527F9B05688C1F83D9AB5BE0CD19";
const dog_number::BigInteger dog_hash::SHA2::b256::MAX = "18446744073709551615";
const uint64_t dog_hash::SHA2::b256::EFFECTIVE_SIZE = 32;
const uint64_t dog_hash::SHA2::b256::BLOCK_SIZE = 64;
const uint64_t dog_hash::SHA2::b256::NUMBER_SIZE = 8;
...
const dog_data::Data dog_hash::SHA2::b224::IV = "C1059ED8367CD5073070DD17F70E5939FFC00B316858151164F98FA7BEFA4FA4";
const dog_number::BigInteger dog_hash::SHA2::b224::MAX = "18446744073709551615";
const uint64_t dog_hash::SHA2::b224::EFFECTIVE_SIZE = 28;
const uint64_t dog_hash::SHA2::b224::BLOCK_SIZE = 64;
const uint64_t dog_hash::SHA2::b224::NUMBER_SIZE = 8;
...
const uint64_t dog_hash::SHA2::k_512[80] = {
...
const dog_data::Data dog_hash::SHA2::b512::IV = "6A09E667F3BCC908BB67AE8584CAA73B3C6EF372FE94F82BA54FF53A5F1D36F1510E527FADE682D19B05688C2B3E6C1F1F83D9ABFB41BD6B5BE0CD19137E2179";
const dog_number::BigInteger dog_hash::SHA2::b512::MAX = "340282366920938463463374607431768211455";
const uint64_t dog_hash::SHA2::b512::EFFECTIVE_SIZE = 64;
const uint64_t dog_hash::SHA2::b512::BLOCK_SIZE = 128;
const uint64_t dog_hash::SHA2::b512::NUMBER_SIZE = 16;
...
const dog_data::Data dog_hash::SHA2::b384::IV = "CBBB9D5DC1059ED8629A292A367CD5079159015A3070DD17152FECD8F70E593967332667FFC00B318EB44A8768581511DB0C2E0D64F98FA747B5481DBEFA4FA4";
const dog_number::BigInteger dog_hash::SHA2::b384::MAX = "340282366920938463463374607431768211455";
const uint64_t dog_hash::SHA2::b384::EFFECTIVE_SIZE = 48;
const uint64_t dog_hash::SHA2::b384::BLOCK_SIZE = 128;
const uint64_t dog_hash::SHA2::b384::NUMBER_SIZE = 16;
...
//SM3
const std::string dog_hash::SM3::name = "SM3";
const std::string dog_hash::SM3::effective_region = "32";
const dog_hash::HashConfig dog_hash::SM3::config = HashConfig(name, effective_region);

const dog_data::Data dog_hash::SM3::b256::IV = "7380166F4914B2B9172442D7DA8A0600A96F30BC163138AAE38DEE4DB0FB0E4E";
const dog_number::BigInteger dog_hash::SM3::b256::MAX = "18446744073709551615";
const uint64_t dog_hash::SM3::b256::EFFECTIVE_SIZE = 32;
const uint64_t dog_hash::SM3::b256::BLOCK_SIZE = 64;
const uint64_t dog_hash::SM3::b256::NUMBER_SIZE = 8;
...
const std::vector<dog_hash::HashConfig> dog_hash::list = { SHA2::config, SM3::config };