...
uint64_t dog_number::integer::CRMB(uint64_t n, uint32_t i)
{
	i %= 64;
	return (n >> i) | (n << (64 - i));
}
uint32_t dog_number::integer::CRMB(uint32_t n, uint32_t i)
{
	i %= 32;
	return (n >> i) | (n << (32 - i));
}
uint16_t dog_number::integer::CRMB(uint16_t n, uint32_t i)
{
	i %= 16;
	return (n >> i) | (n << (16 - i));
}
uint8_t dog_number::integer::CRMB(uint8_t n, uint32_t i)
{
	i %= 8;
	return (n >> i) | (n << (8 - i));
}
uint64_t dog_number::integer::CLMB(uint64_t n, uint32_t i)
{
	i %= 64;
	return (n << i) | (n >> (64 - i));
}
uint32_t dog_number::integer::CLMB(uint32_t n, uint32_t i)
{
	i %= 32;
	return (n << i) | (n >> (32 - i));
}
uint16_t dog_number::integer::CLMB(uint16_t n, uint32_t i)
{
	i %= 16;
	return (n << i) | (n >> (16 - i));
}
uint8_t dog_number::integer::CLMB(uint8_t n, uint32_t i)
{
	i %= 8;
	return (n >> i) | (n << (8 - i));
}

dog_number::BigInteger::BigInteger()
{
	this->sign_ = 0;
	this->num_.push_back(0);
}
dog_number::BigInteger::BigInteger(const char* str, const int radix)
{
	const char* p = str;
...
dog_number::BigInteger::BigInteger(const std::string& str, const int radix)
{
...
dog_number::BigInteger::BigInteger(const std::vector<char>& str, const int radix)
{
...
dog_number::BigInteger::BigInteger(uint8_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(uint16_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(uint32_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(uint64_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(int8_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(int16_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(int32_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}
dog_number::BigInteger::BigInteger(int64_t n)
{
	BigInteger::toBigInteger(n).swap(*this);
}

void dog_number::BigInteger::swap(BigInteger& b)
{
	std::swap(this->num_, b.num_);
	std::swap(this->sign_, b.sign_);
}

void dog_number::BigInteger::trims()
{
...
std::string dog_number::BigInteger::getUpHEX()
{
	std::string res;
	if (sign_ == -1)
	{
...
std::string dog_number::BigInteger::getLowHEX()
{
	std::string res;
	if (sign_ == -1)
	{
...
std::string dog_number::BigInteger::getDEC()
{
	/*
...
std::string dog_number::BigInteger::get_num(int radix, bool isUpper)
{
	if (this->get_sign() == 0)
	{
		return "0";
...
std::vector<uint8_t> dog_number::BigInteger::get_bytes()
{
	return this->num_;
}
uint64_t dog_number::BigInteger::size()
{
	return this->num_.size();
}
void dog_number::BigInteger::reserve(uint64_t n)
{
	this->num_.reserve(n);
}
void dog_number::BigInteger::push_back(uint8_t n)
{
	this->num_.push_back(n);
}
void dog_number::BigInteger::pop_back()
{
	this->num_.pop_back();
}
uint8_t& dog_number::BigInteger::at(uint64_t i)
{
	return this->num_.at(i);
}
void dog_number::BigInteger::insert(const std::vector<uint8_t>::iterator pos, uint8_t n)
{
	this->num_.insert(pos, n);
}
char dog_number::BigInteger::get_sign()
{
	return this->sign_;
}
void dog_number::BigInteger::change_sign()
{
	if (this->sign_ != 0)
	{
		this->sign_ *= -1;
...
void dog_number::BigInteger::set_positive()
{
	this->sign_ = 1;
}
void dog_number::BigInteger::set_negative()
{
	this->sign_ = -1;
}
void dog_number::BigInteger::reverse()
{
...
void dog_number::BigInteger::set2b(uint64_t n)
{
	if (n == 0)
	{
		this->sign_ = 0;
...
void dog_number::BigInteger::set0()
{
	this->num_.clear();
	this->num_.push_back(0);
	this->sign_ = 0;
...
std::vector<uint8_t>::iterator dog_number::BigInteger::begin()
{
	return this->num_.begin();
}
std::vector<uint8_t>::iterator dog_number::BigInteger::end()
{
	return this->num_.end();
}

std::vector<uint8_t>::const_iterator dog_number::BigInteger::cbegin()
{
	return this->num_.cbegin();
}
std::vector<uint8_t>::const_iterator dog_number::BigInteger::cend()
{
	return this->num_.cend();
}

std::reverse_iterator<std::vector<uint8_t>::iterator> dog_number::BigInteger::rbegin()
{
	return this->num_.rbegin();
}
std::reverse_iterator<std::vector<uint8_t>::iterator> dog_number::BigInteger::rend()
{
	return this->num_.rend();
}

std::reverse_iterator<std::vector<uint8_t>::const_iterator> dog_number::BigInteger::crbegin()
{
	return this->num_.crbegin();
}
std::reverse_iterator<std::vector<uint8_t>::const_iterator> dog_number::BigInteger::crend()
{
...
*/
dog_number::BigInteger dog_number::BigInteger::toBigInteger(uint8_t n)
{
	BigInteger res;
	if (n == 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(uint16_t n)
{
	BigInteger res;
	if (n == 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(uint32_t n)
{
	BigInteger res;
	if (n == 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(uint64_t n)
{
	BigInteger res;
	if (n == 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(int8_t n)
{
	BigInteger res;
	if (n < 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(int16_t n)
{
	BigInteger res;
	if (n < 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(int32_t n)
{
	BigInteger res;
	if (n < 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::toBigInteger(int64_t n)
{
	BigInteger res;
	if (n < 0)
	{
...
uint8_t& dog_number::BigInteger::operator[](uint64_t i)
{
	return this->num_[i];
}

dog_number::BigInteger dog_number::BigInteger::operator-()
{
...
dog_number::BigInteger dog_number::BigInteger::abs(BigInteger a)
{
	BigInteger res = a;
	res.sign_ = 1;
	return res;
...
int dog_number::BigInteger::abs_compare(BigInteger a, BigInteger b)
{
	if (a.size() != b.size())
	{
		if (a.size() > b.size())
...
dog_number::BigInteger dog_number::BigInteger::add(BigInteger a, BigInteger b)
{
	if (a == 0) { return b; }
	if (b == 0) { return a; }
...
dog_number::BigInteger dog_number::operator+(BigInteger a, BigInteger b)
{
	return dog_number::BigInteger::add(a, b);
}
dog_number::BigInteger dog_number::BigInteger::add_other(BigInteger n)
{
...
void dog_number::operator+=(BigInteger& a, BigInteger b)
{
	a.add_other(b);
}

dog_number::BigInteger dog_number::BigInteger::subtract(BigInteger a, BigInteger b)
{
	if (a == 0)
	{
		b.change_sign();
...
dog_number::BigInteger dog_number::operator-(BigInteger a, BigInteger b)
{
	return dog_number::BigInteger::subtract(a, b);
}
dog_number::BigInteger dog_number::BigInteger::subtract_other(BigInteger n)
{
	n.change_sign();
...
dog_number::BigInteger dog_number::BigInteger::multiplysingle(BigInteger a, BigInteger b)
{
...
dog_number::BigInteger dog_number::BigInteger::multiplyDistribute(BigInteger a, BigInteger b)
{
...
dog_number::BigInteger dog_number::BigInteger::multiplyKaratsuba0(BigInteger a, BigInteger b)
{
	...
	//std::cout << a.getUpHEX() << "*" << b.getUpHEX() << std::endl;
	auto spilt = [](BigInteger& a, uint64_t start, uint64_t end)->dog_number::BigInteger
		{
			BigInteger res;
			res.pop_back();
			res.set_positive();
...
*/
dog_number::BigInteger dog_number::BigInteger::multiplyKaratsuba1(BigInteger a, BigInteger b)
{
...
void dog_number::BigInteger::FFT0(std::vector<std::complex<double>>& a, int inverse)
{
...
void dog_number::BigInteger::FFT1(std::vector<std::complex<double>>& a, int inverse, std::vector<uint64_t>& rev)
{
...
void dog_number::BigInteger::FNTT0(std::vector<uint64_t>& a, int inverse)
{
...
void dog_number::BigInteger::FNTT1(std::vector<uint64_t>& a, int inverse, std::vector<uint64_t>& rev)
{
	int g = 3, mod = 998244353, ig = 332748118;
...
dog_number::BigInteger dog_number::BigInteger::multiplyFFT0(BigInteger a, BigInteger b)
{
	uint64_t n = 1;
...
dog_number::BigInteger dog_number::BigInteger::multiplyFFT1(BigInteger a, BigInteger b)
{
	uint64_t n = 1;
	while (n < a.size() + b.size()) { n <<= 1; }
	std::vector<std::complex<double>> a0(n), b0(n);
...
dog_number::BigInteger dog_number::BigInteger::multiplyFNTT0(BigInteger a, BigInteger b)
{
	uint64_t n = 1;
	while (n < a.size() + b.size()) { n <<= 1; }
...
dog_number::BigInteger dog_number::BigInteger::multiplyFNTT1(BigInteger a, BigInteger b)
{
	uint64_t n = 1;
	while (n < a.size() + b.size()) { n <<= 1; }
	std::vector<uint64_t> a0(n), b0(n);
...
dog_number::BigInteger dog_number::BigInteger::multiply(BigInteger a, BigInteger b)
{
	BigInteger res;
	if (a.get_sign() == 0 || b.get_sign() == 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::multiply_other(BigInteger n)
{
...
std::pair<dog_number::BigInteger, dog_number::BigInteger> dog_number::BigInteger::divideDistribute(BigInteger a, BigInteger b, bool is_round_zero)
{
	if (b.get_sign() == 0)
	{
...
dog_number::BigInteger dog_number::BigInteger::divideNTT1(BigInteger a, BigInteger b)
{
	if (b.get_sign() == 0)
	{
		throw NumberException(DOG_EXCEPTION_MSG_OPINION("Error: Divide by zero\n错误：除0错误"));
...
//大于
bool dog_number::operator>(BigInteger a, BigInteger b)
{
	if (a.get_sign() > b.get_sign())
	{
		return true;
...
bool dog_number::operator>(BigInteger a, uint8_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, uint16_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, uint32_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, uint64_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, int8_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, int16_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, int32_t b)
{
	return a > BigInteger::toBigInteger(b);
}
bool dog_number::operator>(BigInteger a, int64_t b)
{
	return a > BigInteger::toBigInteger(b);
}
...
uint8_t dog_number::integer::available_size(uint64_t n)
{
	if (n == 0) return 1;
	const int front_zero = std::countl_zero(n);
	return (63 - front_zero + 8) / 8;
}
uint8_t dog_number::integer::available_size(uint32_t n)
{
	if (n == 0) return 1;
	const int front_zero = std::countl_zero(n);
	return (31 - front_zero + 8) / 8;
}
uint8_t dog_number::integer::available_size(uint16_t n)
{
	if (n == 0) return 1;
	const int front_zero = std::countl_zero(n);
...
uint8_t dog_number::integer::pick_byte(uint64_t n, uint8_t i)
{
	if (i < 1 || i > 9)
	{
		throw dog_number::NumberException(DOG_EXCEPTION_MSG_OPINION("pick_byte: index out of range"));
	}
	return (n >> ((i - 1) * 8)) & 0xff;
}
uint8_t dog_number::integer::pick_byte(uint32_t n, uint8_t i)
{
	if (i < 1 || i > 5)
	{
		throw dog_number::NumberException(DOG_EXCEPTION_MSG_OPINION("pick_byte: index out of range"));
...
uint8_t dog_number::integer::pick_byte(uint16_t n, uint8_t i)
{
	if (i < 1 || i > 3)
	{
		throw dog_number::NumberException(DOG_EXCEPTION_MSG_OPINION("pick_byte: index out of range"));
...
bool dog_number::region::gap::is_effective(std::string region_str)
{
	//[XX,XX]XX ([]|)
...
std::array<uint64_t, 3> dog_number::region::gap::get_list(std::string region_str)
{
	if (!dog_number::region::gap::is_effective(region_str))
	{
		throw dog_number::NumberException(DOG_EXCEPTION_MSG_OPINION("invalid region string"));
	}
...
bool dog_number::region::gap::is_fall(std::string region_str, uint64_t n)
{
...
bool dog_number::region::array::is_effective(std::string region_str)
{
	// XX,XX
	std::regex r("^((0|[1-9][0-9]*))((,|\\|)(0|[1-9][0-9]*))*$");
	return std::regex_match(region_str, r);
}
std::vector<uint64_t> dog_number::region::array::get_list(std::string region_str)
{
...
bool dog_number::region::array::is_fall(std::string region_str, uint64_t n)
{
...
bool dog_number::region::is_effective(std::string region_str)
{
	if (dog_number::region::gap::is_effective(region_str))
	{
		return true;
	}
	else if (dog_number::region::array::is_effective(region_str))
	{
		return true;
	}
	else
...
bool dog_number::region::is_fall(std::string region_str, uint64_t n)
{
	if (dog_number::region::gap::is_effective(region_str))
	{
		return dog_number::region::gap::is_fall(region_str, n);
	}
	else if (dog_number::region::array::is_effective(region_str))
	{
		return dog_number::region::array::is_fall(region_str, n);
	}
	else
	{
		throw dog_number::NumberException(DOG_EXCEPTION_MSG_OPINION("invalid region string"));
...
uint64_t dog_number::region::NumberIterator::next()
{
	if (!have_next())
	{
		throw dog_number::NumberException(DOG_EXCEPTION_MSG_OPINION("no next"));
	}
	uint64_t result = 0;
	if (this->is_normal_)
	{
